...
class VoltageSelectorModal : public IMenuControllerParams<PresetsSelectors>
{
private:
    Display &display;
...
public:
    explicit VoltageSelectorModal(Display &_display, IPresetsRepository &_repository) : display(_display), repository(_repository), view(_display), selector(3) {}
